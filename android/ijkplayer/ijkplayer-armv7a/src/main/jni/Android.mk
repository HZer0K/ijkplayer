...
MY_APP_FFMPEG_SOURCE_PATH := $(realpath $(MY_APP_ANDROID_ROOT)/contrib/ffmpeg-armv7a)
endif
ifeq ($(TARGET_ARCH_ABI),armeabi)
MY_APP_FFMPEG_OUTPUT_PATH := $(realpath $(MY_APP_ANDROID_ROOT)/contrib/build/ffmpeg-armv5/output)
MY_APP_FFMPEG_INCLUDE_PATH := $(realpath $(MY_APP_FFMPEG_OUTPUT_PATH)/include)
MY_APP_FFMPEG_SOURCE_PATH := $(realpath $(MY_APP_ANDROID_ROOT)/contrib/ffmpeg-armv5)
endif
...
MY_APP_FFMPEG_INCLUDE_PATH := $(realpath $(MY_APP_FFMPEG_OUTPUT_PATH)/include)
MY_APP_FFMPEG_SOURCE_PATH := $(realpath $(MY_APP_ANDROID_ROOT)/contrib/ffmpeg-x86)
endif
ifeq ($(TARGET_ARCH_ABI),x86_64)
MY_APP_FFMPEG_OUTPUT_PATH := $(realpath $(MY_APP_ANDROID_ROOT)/contrib/build/ffmpeg-x86_64/output)
MY_APP_FFMPEG_INCLUDE_PATH := $(realpath $(MY_APP_FFMPEG_OUTPUT_PATH)/include)
MY_APP_FFMPEG_SOURCE_PATH := $(realpath $(MY_APP_ANDROID_ROOT)/contrib/ffmpeg-x86_64)
endif
